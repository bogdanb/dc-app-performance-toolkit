...
def test_1_selenium_rf_pdf_export_dashboard(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.export_dashboard_to_pdf(jira_webdriver, jira_datasets)
